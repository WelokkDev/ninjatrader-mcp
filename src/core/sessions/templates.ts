...
// CME index futures Globex/ETH session. Sun 18:00 ET → Fri 17:00 ET, with
// a daily 17:00–18:00 ET maintenance break (emergent: it's the gap
// between consecutive spans, not a declared break).
//
...
export const NYMEX_ENERGY_ETH: SessionTemplate = {
  ...
  timezone: "America/New_York",
  spans: [
    { openWeekday: 0, openTime: "18:00", closeWeekday: 1, closeTime: "17:00" },
    { openWeekday: 1, openTime: "18:00", closeWeekday: 2, closeTime: "17:00" },
    { openWeekday: 2, openTime: "18:00", closeWeekday: 3, closeTime: "17:00" },
    { openWeekday: 3, openTime: "18:00", closeWeekday: 4, closeTime: "17:00" },
    { openWeekday: 4, openTime: "18:00", closeWeekday: 5, closeTime: "17:00" },
  ],
};
